...
let productController = {
    ...
    show: async(req, res) => {
        ...
        try {
            const product = await db.Product.findByPk(req.params.id, {
                    include: [
                        "brand", "category", "Images", "Modelo", "color"
                    ]
                }
    ...
    create: async(req, res) => {
        try {
            ...
            res.render('productos/createProduct', { categories, brands, colors, Modelos });
        } catch (error) {
            console.log(error);
    ...
    edit: async(req, res) => {
        try {
            const product = await db.Product.findOne({
                ...
                include: ["category", "brand", "Modelo", "color", "Images"]
            });
    ...
    update: async(req, res) => {
        try {
            ...
            let updatedProduct = await db.Product.update({
                ...
                ModeloId: productBody.Modelo_id,
    ...
    search: async(req, res) => {
        try {
            ...
            let products = await db.Product.findAll({
                ...
                include: ["brand", "color", "Modelo", "category", "Images"]
            })
